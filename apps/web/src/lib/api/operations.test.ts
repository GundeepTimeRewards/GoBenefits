...
describe("C1 operation registry", () => {
  test("exposes the C1 operations + Phase D-1..D-4 reads + D-5/D-6 mutations", () => {
    expect(C1_OPERATION_NAMES.length).toBe(28);
    for (const name of [
